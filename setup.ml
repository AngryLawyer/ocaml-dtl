...
(* OASIS_START *)
(* DO NOT EDIT (digest: 429b5dddf1d9d8415bc71d5fb75d7de1) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$dtl_tests", []))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lexer"; "Parser"; "Evaluator"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ßß¼\130,T8Í\030~<Kë\150\159:";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
